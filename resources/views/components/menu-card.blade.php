...
<x-card class="flex flex-col h-full gap-4 overflow-hidden group">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="mt-auto flex items-center justify-between pt-4 border-t border-zinc-100 dark:border-zinc-700">
            <span class="text-lg font-bold text-orange-600">Rp {{ number_format($item->price, 0, ',', '.') }}</span>
